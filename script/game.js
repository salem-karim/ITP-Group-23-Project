...
let name = "Player"; // This should prompt the player to enter a name
let stats = {
  health: 100,
  strength: 10,
  gold: 0,
...
let equipment = ["-", "-"];
let player = new Player(name, stats, equipment, inventory, missions);
...
function addSpecialButtons(textNodeIndex) {
  if (textNodeIndex === 15) {
  ...
  if (whichStory === 1) {
    ...
    if (textNodeIndex === 1 || textNodeIndex === 16 || textNodeIndex === 24) {
      ...
      messageButton.addEventListener("click", () => {
        ...
        if (textNodeIndex === 1) {
          image.src = "..//Notiz_Story_x/Note5.png";
        } else if (textNodeIndex === 16) {
          image.src = "..//Notiz_Story_x/Note4.png";
        } else if (textNodeIndex === 24) {
          image.src = "..//Notiz_Story_x/Note2.png";
        }
