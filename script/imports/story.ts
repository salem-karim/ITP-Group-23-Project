  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        requiredState: (player: Player) => player.stats["gold"] >= 5,
        setState: (player: Player) => {
          player.stats["gold"] -= 5;
          player.stats["health"] = 0;
        },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        requiredState: (player: Player) =>
          player.stats["gold"] >= 50 && player.equipment[1] != "Eisenschild",
        setState: (player: Player) => {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        requiredState: (player: Player) =>
          player.stats["gold"] >= 5 && player.stats["health"] <= 90 /*&&
    ...
    options: [
      {
        ...
        requiredState: (player: Player) => player.stats["strength"] >= 25,
        nextText: 27,
      },
      {
