...
bootstrap_alert.found = function (message) {
  $("#alert_placeholder").html(
    '<div class="alert alert-light"><span>' +
      message +
      " Brenneseln: " +
      goalCounter +
      " Extras: " +
...
function logic(element) {
  ...
  if (temp == "../icons/brenn.png") {
    ...
    bootstrap_alert.found(
      "Das ist Basilikum und keine Brennesel. Bitte halte dein Ziel vor Auge und denk nicht schon wieder an Pizza!",
    );
    ...
    if (poisionCounter < 2)
      ...
      bootstrap_alert.warning(
        "Du hast zu viele giftige Pilze berührt und bist gestorben.  Probier es nochmal!",
      );
      setTimeout(function () {
