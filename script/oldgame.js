  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        requiredState: (player) =>
          player.strength >= 15 &&
          (player.ring == false || player.sword == false),
        nextText: 19,
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        requiredState: (player) =>
          player.gold >= 50 && player.shield != "Eisenschild",
        setState: () => {
          player.gold -= 50;
          player.shield = "Eisenschild";
        },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        text: "Bier geben",
        requiredState: (player) =>
          player.beer == true && player.beerMission == false,
        setState: () => {
          player.gold += 50;
      ...
      },
      {
        text: "Ring geben",
        requiredState: (player) =>
          player.ring == true && player.ringMission == false,
        setState: () => {
          player.gold += 50;
      ...
      },
      {
        text: "Schwert geben",
        requiredState: (player) =>
          player.sword == true && player.swordMission == false,
        setState: () => {
          player.gold += 50;
    ...
    options: [
      {
        ...
        requiredState: (player) =>
          player.ring == false && player.ringMission == false,
        setState: () => {
          player.health -= 10;
        },
        nextText: 20,
      },
      {
        ...
        requiredState: (player) =>
          player.swordMission == false && player.sword == false,
        nextText: 34,
      },
      {
